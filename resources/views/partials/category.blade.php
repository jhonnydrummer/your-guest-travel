        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-head">
                        <h2 style="margin: 10px">{{$categoryName}}</h2>
                    </div>
                            ...
                            @foreach($products as $product)
                                <div class="product">
                                    ...
                                    <div class="btn-verMais_addCarrinho">
                                        ...
                                        <!-- Modal produto -->
                                        <div class="modal fade bd-example-modal-xl" id="modal{{$product->id}}" tabindex="-1" role="dialog" aria-labelledby="modalTitle{{$product->id}}" aria-hidden="true">
